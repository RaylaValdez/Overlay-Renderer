...
namespace Overlay_Renderer.Methods
{
    public class ImGuiStylePresets
    {
        public static void ApplyDark()
        {
            ...
            colors[(int)ImGuiCol.WindowBg] = new Vector4(0.10f, 0.10f, 0.10f, 0.94f);
            ...
            colors[(int)ImGuiCol.CheckMark] = new Vector4(0.90f, 0.45f, 0.00f, 1.00f);
            colors[(int)ImGuiCol.SliderGrab] = new Vector4(0.90f, 0.45f, 0.00f, 1.00f);
            colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(1.00f, 0.60f, 0.00f, 1.00f);
            ...
            colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.90f, 0.45f, 0.00f, 1.00f);
        }
